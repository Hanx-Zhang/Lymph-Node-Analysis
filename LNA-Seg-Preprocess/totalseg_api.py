...
if __name__ == "__main__":
    ...
    input_path = r"../pat001.nii.gz"
    output_path = r"pat001_seg.nii.gz"
    roi_subset_robust = [
        "lung_upper_lobe_left", "lung_lower_lobe_left", "lung_upper_lobe_right", "lung_middle_lobe_right",
        "lung_lower_lobe_right", "esophagus", "aorta", "brachiocephalic_trunk", "subclavian_artery_right",
        "subclavian_artery_left", "common_carotid_artery_right", "common_carotid_artery_left",
        "brachiocephalic_vein_left", "brachiocephalic_vein_right", "superior_vena_cava", "inferior_vena_cava",
        "portal_vein_and_splenic_vein", "iliac_artery_left", "iliac_artery_right", "iliac_vena_left",
        "iliac_vena_right", "heart"
    ]
    totalsegmentator(input_path, output_path, ml=True, roi_subset_robust=roi_subset_robust, remove_small_blobs=True)

    output_path_heartchambers = r"pat001_seg_heartchambers.nii.gz"
    totalsegmentator(input_path, output_path_heartchambers, ml=True, task="heartchambers_highres", remove_small_blobs=True)
